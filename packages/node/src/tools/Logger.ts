...
export class Logger implements ILogger {
  ...
  for(service: object | string): Logger {
    const name =
  ...
  private print(level: string, parameters: LoggerParameters): void {
  ...
  private printJson(level: string, parameters: LoggerParameters): void {
  ...
  private printPretty(level: string, parameters: LoggerParameters): void {
...
function getPrettyParameters(parameters: LoggerParameters | undefined): string {
